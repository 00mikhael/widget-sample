...
const ChatHeader: React.FC<ChatHeaderProps> = ({ onClose, onClearChat }) => {
  ...
  return (
    <div className="flex items-center justify-between bg-gray-800 p-4 text-white">
      <h3 id="chat-widget-title" className="font-semibold">Mixhers AI Assistant</h3>
      <div className="flex gap-2">
        ...
        <button
          ...
          className="flex items-center justify-center w-9 h-9 rounded-3xl text-gray-300 hover:bg-gray-700 hover:scale-105 transition-all transform"
